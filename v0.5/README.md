...
- `../v0.4/README.md`
- `https://github.com/lumenaut-llc/oesis-program-specs/blob/main/release/v0.5/README.md`
- `https://github.com/lumenaut-llc/oesis-program-specs/blob/main/release/v0.5/v0.5-scope-matrix.md`
